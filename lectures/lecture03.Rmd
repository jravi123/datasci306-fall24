...
Here is another example using `mpg` dataset
...
Let's visit the ggplot docs for scatter plot: [`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)
